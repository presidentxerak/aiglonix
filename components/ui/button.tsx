...
const buttonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 rounded-none text-sm font-bold transition-all duration-200 ease-out focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent disabled:pointer-events-none disabled:opacity-50 min-h-11 px-4 cursor-pointer will-change-transform hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        primary:
          "btn-gradient shadow-[0_0_0_0_rgba(244,63,94,0)] hover:shadow-[0_10px_28px_-8px_rgba(244,63,94,0.55)]",
        secondary:
